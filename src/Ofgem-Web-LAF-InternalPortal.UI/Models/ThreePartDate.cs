...
namespace Ofgem_Web_LAF_InternalPortal.Models
{
    public class ThreePartDate
    {
        ...
        private bool IsAllPartsEmpty() => Day == 0 && Month == 0 && Year == 0;

        private bool IsTwoPartsEmpty() => (Day == 0 && Month == 0) || (Day == 0 && Year == 0) || (Month == 0 && Year == 0);

        private bool IsInvalidDayForMonth() => Month is 2 or 4 or 6 or 9 or 11 && Day > 30;

        private bool IsInvalidLeapYear() => Month == 2 && Day > 28 && !DateTime.IsLeapYear(Year);
